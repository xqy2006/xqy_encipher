...
def coding(dir,mima,mima_len):
    ...
    p2 = Process(target=realcode1, args=(dir,mima,mima_len,max//4,2,q,))
    p3 = Process(target=realcode1, args=(dir,mima,mima_len,(max*2)//4,3,q,))
    p4 = Process(target=realcode1, args=(dir,mima,mima_len,(max*3)//4,4,q,))
    p1.start()
    p2.start()
    p3.start()
    p4.start()
...
def function3():#jiami
    ...
    if save_dir!='':
        ...
        bar1['maximum'] = int(file_stats.st_size)+1
